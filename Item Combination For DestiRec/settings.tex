...
\usepackage[%
  backend=biber,
  url=false,
  style=ieee, % alphabetic, numeric
  sorting=none, % default == nty,
  ]{biblatex} 
\usepackage{graphicx}
...
\makeglossaries
\loadglsentries{Item Combination For DestiRec/pages/glossary.tex} % important update for glossaries, before document
...
\graphicspath{
    {Item Combination For DestiRec/logos/}
    {Item Combination For DestiRec/figures/}
}
...
\newcommand{\note}[1]{{\bfseries{\scshape{\color{TUMAccentGreen}[(NOTE: #1)]}}}}
